...
export const PrivateRoute: React.FC<PrivateRouteProps> = ({ children, skipOnboardingCheck = false }) => {
    ...
    // Las cuentas del sistema (oficiales, admins, etc. autenticados vía Firebase Auth) acceden sin Onboarding por ser gestores
    if (!skipOnboardingCheck && !mainCharacter && !user) {
